/**
 * CONFIGURAÇÃO DE MARKETING — PREENCHA SOMENTE ENTRE AS ASPAS.
 * Salve este arquivo e publique novamente no GitHub.
 * Deixe vazio para desativar a ferramenta correspondente.
 * Não coloque senhas, tokens de API ou o código completo do pixel aqui.
 */
window.SOPHIA_CONFIG = Object.freeze({
  // Formspree: cole a URL pública do formulário criado na SUA conta.
